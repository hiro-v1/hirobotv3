...
_buttons = {
    "otvars": {
        "text": "Other Variables to set for @hiro_v1:",
        "buttons": [
            [
    ...
    "oofdm": {
        "text": "About [Dual Mode](https://t.me/hiro_v1/18)",
        "buttons": [
            [
...
async def _(e):
    if not e.is_private:
        return
    await e.edit(
        "Click Authorise and send the code.\n\nYou can use your own CLIENT ID and SECRET by [this](https://t.me/molemutualan/37)",
        buttons=[
            [
